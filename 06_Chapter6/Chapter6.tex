...
\begin{figure}[h]
    \centering
    \noindent\shadowimage[width=0.5\linewidth]{img/cad.PNG}
...
\begin{figure}[h!]
    \centering
    \noindent\shadowimage[width=0.77\linewidth]{img/robodk_cast.PNG}
...
\begin{figure}[h]
    \centering
    \noindent\shadowimage[width=0.6\linewidth]{img/peening_v2.png}
